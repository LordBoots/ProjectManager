...
# Items
==================================================
  Items are all stored in the inventory.
  ...
  ==================================================
   ...
   They are primarily used as rare items that allow players to level the odds on rolls OR access locations and activities that are otherwise not available.
...
==================================================
  ...
  [Avialbility]:
   ...
   Thier pickup locations vary and are relative to the type of activity they represent.
...
# Accomodation
==================================================
  The player can store their fighters, goods and sleep at their place of residence as long as it is not the streets.
...
==================================================
  ...
  Fights are up to 5v5.
  Fights are scheduled typically.
  ...
  [Sheduling a Fight]:
   Fights are scheduled through the Arena UI and are shown on the calendar.
